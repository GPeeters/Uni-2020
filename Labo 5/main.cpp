...
int main() {
    ...
    Verzameling<Afspraak> v1; //default alles nul
    Verzameling<Afspraak> v2(20); //parameter -> grootte, array 20 plaatsen
    v1.add(&a1);
    v1.add(&a2);
    v1.add(&a3);
    v1.add(&a4);
    ...
    cout << "v1: " << v1 << endl;
    cout << "v2: " << v2 << endl;
    Verzameling<Afspraak> v3 = v2;
    cout << "v3: " << v3 << endl;
    Verzameling<Afspraak> v4,v5;
    v4 = v1 + v2; //unie
    v5 = v1 * v2; //doorsnede
    cout << "v4: " << v4 << endl;
    cout << "v5: " << v5 << endl;
    v4 = v1 + (Verzameling<Afspraak>)&a10;
    v5 = (Verzameling<Afspraak>)&a11 + v1;
    cout << "v4: " << v4 << endl;
    cout << "v5: " << v5 << endl;
    return 0;
}
